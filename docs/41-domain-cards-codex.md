...
d10+2 magic damage using your Proﬁciency.
Tava’s Armor: Spend a Hope to give a target you can touch a 
+1 bonus to their Armor Score until their next rest or you cast 
Tava’s Armor again.
Ice Spike: Make a Spellcast Roll/uni00A0(12) to summon a large ice 
spike within Far range. If you use it as a weapon, make the 
Spellcast Roll against the target’s Diﬃculty instead. On a 
success, deal d6 physical damage using your Proﬁciency.
BOOK OF ILLIAT
Level 1 Codex Grimoire
Recall Cost: 2
...
creature at a time.
Illusion: Make a Spellcast Roll/uni00A0(14) . 
...
holds up to scrutiny until an observer is within Melee range.BOOK OF VAGRAS
Level 2 Codex Grimoire
Recall Cost: 2
Runic Lock: Make a Spellcast Roll/uni00A0(15) on an object you’re 
...
to make a Reaction Roll/uni00A0(15). On a failure, they forget the last 
...
when they take any amount of damage.BOOK OF GRYNN
Level 4 Codex Grimoire
Recall Cost: 2
Arcane Deﬂection: Once per long rest, spend a Hope to negate 
...
create a temporary wall of magical ﬂame between two points 
...
Spellcast Roll/uni00A0(16) :
• If you know the place very well, gain a +3 bonus. 
• If you’ve visited the place frequently, gain a +1/uni00A0bonus. 
• If you’ve visited the place infrequently, gain no modiﬁer. 
• If you’ve only been there once, gain a −2 penalty.
On a success, you appear where you were intending to go. 
On a failure, you appear oﬀ course, with the range of failure 
determining how far oﬀ course.
BANISH
Level 6 Codex Spell
Recall Cost: 0
...
The target must make a reaction roll with a Diﬃculty equal 
...
When the PCs roll with Fear, the Diﬃculty gains a −1 penalty 
and the target makes another reaction roll. On a success, they 
return from banishment.SIGIL OF RETRIBUTION
Level 6 Codex Spell
Recall Cost: 2
...
This eﬀect ends when the marked adversary is defeated or you 
cast Sigil of Retribution again.
BOOK OF HOMET
Level 7 Codex Grimoire
Recall Cost: 0
Pass Through: Make a Spellcast Roll/uni00A0(13) . Once per rest on a 
success, you and all creatures touching you can pass through a 
wall or door within Close range. The eﬀect ends once everyone 
is on the other side.
Plane Gate: Make a Spellcast Roll/uni00A0(14) . Once per long rest on 
...
the Codex domain, gain the following beneﬁts:
• You can mark a Stress to add your Proﬁciency to a 
Spellcast Roll.
...
Diﬃculty of 18 or lower. Mark a Stress for each one you wish 
to hit with this spell. They are killed and can’t come back to life 
by any means.BOOK OF YARROW
Level 10 Codex Grimoire
Recall Cost: 2
Timejammer: Make a Spellcast Roll/uni00A0(18) . On a success, time 
