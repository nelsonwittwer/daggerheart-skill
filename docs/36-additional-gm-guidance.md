...
of the narrative—a shift in the world, a signiﬁcant action or 
...
scripting speciﬁc details or exchanges.
PREPARING COMBAT 
ENCOUNTERS
...
or unexpected about the ﬁction.ENGAGING YOUR PLAYERS
Keep your players engaged by:
• Rotating the Focus between the PCs
• Tying T ogether Story Elements
• Engaging Quiet Players
• Using Visual Aids
• Encouraging Unguided Play
• Confronting the PCs with internal and external conﬂicts
...
work with other players whose characters are involvedPROJECTS DURING DOWNTIME
...
• Guidance for ﬁtting communities, ancestries, and classes 
into the setting
...
You can ﬁnd each campaign frame map in the appendix of
